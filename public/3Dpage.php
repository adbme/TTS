...
<button onclick="playAudio()" id="menuButton">Menu <p
    style="color: #384047; font-size: 14px; margin-left: 15px; padding-top: 15px;">m</p> </button>
...
<div id="menu">
  ...
  <div class="bouttonTopBottom">
    ...
    <div id="bouton-play1" onclick="playAudio()" class="boutton4">TOP <p class="floor">floor</p>
    </div>
    <!-- <button  id="bouton-play1" onclick="playAudio()" class="boutton4">TOP <p class="floor">floor</p></button> -->

    <div id="bouton-play2" onclick="playAudio()" class="boutton4">BOTTOM <p class="floor">floor</p>
    </div>
